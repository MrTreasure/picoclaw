...
type AgentDefaults struct {
	...
	DailySessionReset         DailySessionResetConfig  `json:"daily_session_reset,omitempty"`
	SessionMaintenance        SessionMaintenanceConfig `json:"session_maintenance,omitempty"`
...
// SessionMaintenanceConfig bounds short-term chat history by completed user turns.
// Tool calls and assistant messages within a turn do not increase the turn count.
type SessionMaintenanceConfig struct {
	Enabled             bool     `json:"enabled,omitempty"`
	Channels            []string `json:"channels,omitempty"`
	SummarizeEveryTurns int      `json:"summarize_every_turns,omitempty"`
	CleanupAfterTurns   int      `json:"cleanup_after_turns,omitempty"`
	RetainRecentTurns   int      `json:"retain_recent_turns,omitempty"`
}
