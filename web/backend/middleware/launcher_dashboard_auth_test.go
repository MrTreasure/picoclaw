...
func TestLauncherDashboardAuth_AllowsPublicPaths(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{http.MethodGet, "/sw.js", http.StatusTeapot},
		{http.MethodGet, "/offline.html", http.StatusTeapot},
		{http.MethodGet, "/web-app-manifest-192x192.png", http.StatusTeapot},
		{http.MethodGet, "/web-app-manifest-512x512.png", http.StatusTeapot},
